...
export interface AppInfoStore {
  ...
  m_mapRichPresenceLoc: ObservableMap<string, m_mapRichPresenceLoc>;
...
export interface AppSpotlightStore {
  ...
  m_localStorage: m_localStorage;
  m_mapAppData: Map<number, m_mapAppData26>;
}
...
export interface m_mapRichPresenceLoc {
  GetAppID(): unknown;
...
export interface m_mapAppData26 {
...
export interface AppActivityByDay {
  ...
  dayBegin?: never;
  events: (LastAddedPartnerEvent[] | Events2[] | (LastAddedPartnerEvent | Events2)[]);
  isValid: boolean;
  ...
  m_mapVideosByUser: Map<number, Events2>;
  m_mapWishlistedGameByUser: Map<number, Events2>;
  m_rgEvents: (LastAddedPartnerEvent[] | Events2[] | (LastAddedPartnerEvent | Events2)[]);
  m_rtDayBegin?: never;
}
...
export interface m_rgCachedUserNewsEvents {
  ...
  gameid(): unknown;
  getClassName(): string;
  getExtension(e: unknown): unknown;
  getJsPbMessageId(): unknown;
  packageid(): unknown;
  publishedfileid(): unknown;
  serializeBase64String(): unknown;
  serializeBinary(): unknown;
  ...
  setExtension(e: unknown, t: unknown): unknown;
  shortcutid(): unknown;
  steamid_actor(): unknown;
  steamid_target(): unknown;
  syncMapFields_(): void;
  toArray(): unknown;
  toObject(e?: boolean /* default = !1 */): unknown;

  array: ((number | string | undefined | unknown/* circular reference to array */)[] | (number | string | undefined | string[] | unknown/* circular reference to array */)[] | (number | string | undefined)[]);
  arrayIndexOffset_: number;
  convertedPrimitiveFields_: (object | unknown);
  messageId_?: never;
  pivot_: number;
  wrappers_: null;
}
...
export interface m_rgCachedGameActivityEvents extends Message {
  data1(): unknown;
  data2(): unknown;
  data3(): unknown;
  data4(): unknown;
  ...
  array: (undefined | number | string | Uint8Array)[];
  arrayIndexOffset_: number;
  convertedPrimitiveFields_: (object | unknown);
