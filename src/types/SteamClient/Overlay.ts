...
import { ESteamRealm, EUIComposition, Unregisterable } from './shared';
...
export interface Overlay {
  ...
  HandleGameWebCallback(url: string): unknown;
  ...
  RegisterForNotificationPositionChanged(
    callback: (appId: unknown, position: ENotificationPosition, horizontalInset: number, verticalInset: number) => void,
  ): Unregisterable;
  ...
  SetOverlayState(appId: number, uiComposition: EUIComposition): unknown;
}
