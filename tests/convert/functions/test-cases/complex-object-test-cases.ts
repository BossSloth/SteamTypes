...
export const complexObjectTestFunctions: Record<string, TestFunction> = {
  ...
  returnMixedPropertyObject: {
    ...
    expected: 'returnMixedPropertyObject(): { string: string; number: number; boolean: boolean; array: number[]; object: { nested: boolean; }; func: () => string; nullable: null; undefinedArg: undefined; };',
  },
  ...
  returnComputedPropertyObject: {
    ...
    expected: 'returnComputedPropertyObject(): { [x: string]: string; key3: string; };',
  },
